...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_fix_fullheight_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions/fix-fullheight.js */ "./src/js/functions/fix-fullheight.js");
...
if (heroSlider) {
  ...
  const getCards = () => Array.from(paginationContainer && paginationContainer.querySelectorAll(".hero__pagination-card") || []);
...
function getAutoplayDelay(swiperInstance) {
  return (swiperInstance && swiperInstance.params && swiperInstance.params.autoplay && swiperInstance.params.autoplay.delay || 5000) + 500;
}
...
function updateProgress(swiperInstance) {
  ...
  const rawIndex = typeof swiperInstance.realIndex === "number" ? swiperInstance.realIndex : typeof swiperInstance.activeIndex === "number" ? swiperInstance.activeIndex : 0;
  ...
  startProgressBar(currentCard.querySelector(".hero__pagination-progress"), duration);
}
...
function startActiveProgressBar(swiperInstance) {
  ...
  if (activeCard) {
    ...
    startProgressBar(activeCard.querySelector(".hero__pagination-progress"), duration);
  }
}
...
let fixHeight = (0,_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(fixFullheight);
fixHeight();
